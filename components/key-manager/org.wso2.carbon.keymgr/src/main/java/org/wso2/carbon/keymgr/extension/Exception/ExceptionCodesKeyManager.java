...
public enum
ExceptionCodesKeyManager implements KeyManagerErrorHandler {
     ...
     */
    ExceptionCodesKeyManager(long errorCode, String msg, int httpErrorCode, String errorDescription, boolean stackTrace) {
     ...
     * @param errorDescription The error description.
     */
    ExceptionCodesKeyManager(long errorCode, String msg, int httpErrorCode, String errorDescription) {
        this.errorCode = errorCode;
        this.errorMessage = msg;
        this.httpStatusCode = httpErrorCode;
        this.errorDescription = errorDescription;
